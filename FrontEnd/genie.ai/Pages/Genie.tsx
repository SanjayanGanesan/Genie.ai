        ...
        <main className="w-[80%]">
          ...
          {activeSection == "conversations" && (
            <ConversationPanel
              ...
              messages={[
                {
                  id: "1",
                  role: "guest",
                  content: "Can we upgrade to the suite?",
                  timestamp: "12:41 PM",
                },
                {
                  id: "2",
                  role: "assistant",
                  content: "Sure! The Ocean Suite is available for $145/night.",
                },
                {
                  id: "3",
                  role: "staff",
                  content: "I've gone ahead and processed the upgrade for you.",
                },
              ]}
              ...
              // ── Callbacks ──
              onSuggestionClick={(s) =>
                console.log("Suggestion clicked:", s.label)
              }
